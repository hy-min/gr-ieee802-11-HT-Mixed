...
- [Phase 107 Deep Root Cause 2026-07-06](project_p107_deep_root_cause.md) — **2026-07-06** — ULTIMATE ROOT CAUSE: 30° constant phase rotation + 27-50% |H| CV. H52 std(argH)=108° (huge phase spread), L-SIG eq |eq|² median=0.81 (32.7%<0.5, 23.2%>=2.0). TWO root causes: (1) per-SC H noise from freq-selective, (2) 30° constant offset from SFO/CP timing. Equalizer-layer fixes won't work — need upstream FFT window fix. Phase 108+ plan: dump FFT window positions. Verdict: 2026-07-06-phase107-deep-root-cause.md.
