...
enabled: true
event: bash
pattern: IEEE80211_(HTSIG_SOFT_LLR_VITERBI|HTSIG_SOFT_LLR_V2|HTSIG_LIST_VITERBI|LSIG_FINE_ROT|WIENER_H52|H52_FREQ_LOWPASS|TX_PREEMPHASIS|TIMING_OFFSET_APPLY|HTLTF_AVG|CONST_CPE_APPLY|HTSIG_PILOT_CPE|USE_LDPC|SYNC_LONG_USE_COMPUTED_FS)\s*=\s*[1-9]|IEEE80211_SYNC_SHORT_(COR_FLOOR|CONFIRM_)|--ldpc\b
---
