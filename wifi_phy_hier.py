...
class wifi_phy_hier(gr.hier_block2):
    def __init__(self, bandwidth=10e6, chan_est=ieee802_11.LS, encoding=ieee802_11.BPSK_1_2, frequency=5.89e9, sensitivity=0.56, use_ldpc=False):
        ...
        self.blocks_multiply_xx_0.set_min_output_buffer(500000)
        self.blocks_moving_average_xx_1 = blocks.moving_average_ff((window_size  + 16), 1, 4000, 1)
        self.blocks_moving_average_xx_1.set_min_output_buffer(500000)
        self.blocks_moving_average_xx_0 = blocks.moving_average_cc(window_size, 1, 4000, 1)
        self.blocks_moving_average_xx_0.set_min_output_buffer(500000)
        self.blocks_divide_xx_0 = blocks.divide_ff(1)
        self.blocks_divide_xx_0.set_min_output_buffer(500000)
        self.blocks_delay_0_0 = blocks.delay(gr.sizeof_gr_complex*1, 16)
        self.blocks_delay_0_0.set_min_output_buffer(500000)
        self.blocks_delay_0 = blocks.delay(gr.sizeof_gr_complex*1, sync_length)
        self.blocks_delay_0.set_min_output_buffer(500000)
        self.blocks_conjugate_cc_0 = blocks.conjugate_cc()
        self.blocks_conjugate_cc_0.set_min_output_buffer(500000)
        self.blocks_complex_to_mag_squared_0 = blocks.complex_to_mag_squared(1)
        self.blocks_complex_to_mag_squared_0.set_min_output_buffer(500000)
        self.blocks_complex_to_mag_0 = blocks.complex_to_mag(1)
        self.blocks_complex_to_mag_0.set_min_output_buffer(500000)
